...
public:
	...
	void trigger();
	void trigger(int percentage);

	/*ProgressBar比Button多出的三个方法*/
	void setProgressPercentage(int);
	int getProgressPercentage();
	void setOnProgressFinishCallBack(BCallBack _callBack);
...
protected:
	...
	Gdiplus::RectF rect;
	/*点击事件回调函数指针*/
	BCallBack clickedCallBack;
	BCallBack progressFinishCallBack;
	int x, y;
	int width, height;
	Text text;
